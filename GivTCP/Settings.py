# version 2022.01.31
class GiV_Settings:
    invertorIP="192.168.1.94"                   #Required - IP address of Invertor on local network
    numBatteries=1                  #Required - The number of batteries connected this invertor
    HA_Auto_D=False                 #Optional - Bool - Publishes Home assistant MQTT Auto Discovery messages to push data into HA automagically (requires MQTT to be enabled below)
#Debug Settings
...
#MQTT Output Settings
    MQTT_Output= False              #Optional - Bool - True or False
